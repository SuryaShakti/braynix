                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                  {features.map((feature) => (
                    <div key={feature.name} className=" pt-6">
                      <div className="flow-root shadow-xl group transition duration-75 hover:duration-500 hover:bg-gradient-to-r hover:from-teal-500 hover:to-cyan-600 hover:scale-105 hover:-translate-y-2 bg-gray-100 rounded-lg px-6 pb-8">
                        <div className="-mt-6">
                          <div>
